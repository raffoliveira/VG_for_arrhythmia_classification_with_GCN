...
if __name__ == "__main__":
    ...
    train_signals_V1, train_signals_II = gcn_functions.segmentation_signals_v1_ii(
        path=PATH, list_ecgs=files_train, size_beat_before=100, size_beat_after=130, set_name="Train")
    val_signals_V1, val_signals_II = gcn_functions.segmentation_signals_v1_ii(
        path=PATH, list_ecgs=files_val, size_beat_before=100, size_beat_after=130, set_name="Train")
